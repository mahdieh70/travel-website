...
import { citiesOfSpainData } from "../../sliders/citiesAndTownSlider/index";

const delay = 6000;
const CitiesAndTownOfSpain = () => {
    ...
    timeoutRef.current = setTimeout(
      () =>
        setCurrentSlide((prevIndex) =>
          prevIndex === citiesOfSpainData.length - 1 ? 0 : prevIndex + 1
        ),
      delay
    );
...
export default CitiesAndTownOfSpain;
