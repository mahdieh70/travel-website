          ...
          <div className="w-full">
            ...
            >
              <div
                className={
                  i18n.language === "en"
                    ? "large:flex justify-between items-center"
                    : "large:flex justify-between items-center large:flex-row-reverse"
                }
              >
                <div className="large:w-[22%]">
                  <h4
                    className={
                      i18n.language === "en"
                        ? "text-[20px] text-white font-bold my-[15px] capitalize"
                        : "text-[20px] text-white font-bold my-[15px] capitalize direction medium:text-right"
                    }
                  >
                    {t("sort deals by")}:
                  </h4>
                ...
                <div className="large:w-[22%]">
                  <fieldset className="border-none outline-none ">
                    <select
                      ...
                      className={
                        i18n.language === "en"
                          ? "mb-[30px]  outline-none border-b border-solid border-white border-x-0 border-t-0 w-full bg-teal-color text-[15px] text-white py-2 px-2"
                          : "mb-[30px]  outline-none border-b border-solid border-white border-x-0 border-t-0 w-full bg-teal-color text-[15px] text-white py-2 px-2 direction medium:text-right"
                      }
                    >
                ...
                <div className="large:w-[22%]">
                  <fieldset className="border-none outline-none ">
                    <button
                      ...
                      className={
                        i18n.language === "en"
                          ? "w-full capitalize text-center text-[14px] text-white bg-transparent border border-solid border-white py-2 px-[30px] inline-block rounded-[25px] font-medium tracking-[0.5px] overflow-hidden cursor-pointer"
                          : "w-full capitalize text-center text-[16px] text-white bg-transparent border border-solid border-white py-2 px-[30px] inline-block rounded-[25px] font-medium tracking-[0.5px] overflow-hidden cursor-pointer persionFontFamily"
                      }
                    >
                      {t("search results")}
                    </button>
