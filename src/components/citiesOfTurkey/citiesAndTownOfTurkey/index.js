...
import { citiesOfTurkeyData } from "../../sliders/citiesAndTownSlider/index";

const delay = 6000;

const CitiesAndTownOfTurkey = () => {
        ...
        <div className="mx-3">
          <div className="flex flex-col w-full ">
            ...
            <div className="rounded-[10px] overflow-hidden relative">
              <img
                src={citiesOfTurkeyData[currentSlide].image}
                alt="imag"
                className="aspect-square w-full h-full"
              />
              <h4 className="absolute left-[30px] bottom-[30px] text-[20px] text-white font-bold">
                {citiesOfTurkeyData[currentSlide].townName}
              </h4>
            </div>
          </div>
        </div>
...
export default CitiesAndTownOfTurkey;
