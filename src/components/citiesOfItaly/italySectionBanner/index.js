...
const ItalySectionBanner = () => {
  return (
    <>
      <section className="mt-[70px] large:mt-[70px]">
        <div className="bg-center bg-[url('https://i.postimg.cc/mgwyQpfg/8-4.jpg')] bg-no-repeat bg-cover bg-fixed py-[130px] w-full ">
          <div className="mx-3">
            <div>
              <div className="text-white rounded-[23px] text-center py-30 px-15 relative overflow-hidden z-[2] py-[120px] px-[60px]">
                <div
                  className="w-full h-full bg-center bg-[url('https://i.postimg.cc/mgwyQpfg/8-4.jpg')] bg-no-repeat bg-fixed bg-cover absolute left-0 top-0 z-[1]"
...
export default ItalySectionBanner;
